...
res2 <- tbl(sql_conn,"population")

res <- dbGetQuery(conn = sql_conn,
                  statement = "
                  SELECT
                  w.country, w.year, w.new_sp_m014, p.population
                  FROM
                  who w
                  JOIN
                  population p
...
res <- dbGetQuery(conn = sql_conn,
                       statement = "
                SELECT who.country, who.year, who.new_sp_m014
                FROM who 
